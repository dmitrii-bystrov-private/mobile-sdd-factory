#!/usr/bin/env python3
"""Validate two real implementer rounds against a launcher-backed Claude role."""
...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="sdd-factory-real-two-round-live.") as temp_dir:
        ...
        print(f"Real implementer two-round validation passed for session {session_id}.")
