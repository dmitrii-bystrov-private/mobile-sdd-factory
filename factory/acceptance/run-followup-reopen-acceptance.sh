...
CREATE_PAYLOAD='{"task_key":"IOS-ACCEPT-REOPEN-001","workflow_profile":"oneshot","prepare":true,"policy":{"self_review_policy":"required","boy_scout_policy":"disabled","doc_harvest_policy":"disabled"}}'
