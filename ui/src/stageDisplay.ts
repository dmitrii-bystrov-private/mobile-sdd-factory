const STAGE_LABELS: Record<string, string> = {
  ...
  convention_review_requested: "Convention Review",
  convention_review_correction_requested: "Convention Review Correction",
  requirements_review_requested: "Requirements Review",
  requirements_review_correction_requested: "Requirements Review Correction",
