...
Roles such as Convention Reviewer, Requirements Reviewer, Verification Coordinator, and Documentation Writer receive an empty scoped MCP config by default.
