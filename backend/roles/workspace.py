    ...
    return "\n".join(
        [
            ...
            *relevant_paths,
            ...
            f"- For terminal outcomes, use `python \"$SDD_FACTORY_REPO_ROOT/scripts/write-result.py\" <role-name> --output \"{role_directory / 'RESULT.json'}\" ...` instead of hand-writing JSON.",
            f"- Write `RESULT.json` exactly to `{role_directory / 'RESULT.json'}` before you finish the turn.",
